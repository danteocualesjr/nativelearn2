...
struct CompanionPanelView: View {
    ...
    private var permissionsCopySection: some View {
        if companionManager.hasCompletedOnboarding && companionManager.allPermissionsGranted {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("Some permissions were revoked. Grant all four below to keep using NativeLearn.")
                    .font(.system(size: 11))
                    .foregroundColor(DS.Colors.textTertiary)
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("Nothing runs in the background. NativeLearn will only take a screenshot when you press the hot key. So, you can give that permission in peace.")
                    .font(.system(size: 11))
    ...
    private var feedbackButton: some View {
        Button(action: {
            if let url = URL(string: "https://x.com/dantecualesjr") {
                NSWorkspace.shared.open(url)
            }
        }) {
            HStack(spacing: 8) {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    ...
                    Text("Bugs, ideas, feature requests — I read every message.")
                        .font(.system(size: 10))
                        .foregroundColor(DS.Colors.textTertiary)
                }
            }
