...
An AI tutor that lives on your Mac. Vibecademy places a companion cursor called **Sparkle** (an orange sparkle shape) right next to your pointer that can see your screen, listen to your voice, and teach you how to use AI tools step by step.
...
1. Open Vibecademy — the desktop app window appears with a "Meet Sparkle" hero card
